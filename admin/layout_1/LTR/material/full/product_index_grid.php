				...
				<div class="row">
					<div class="col-xl-12">
						...
						<div class="card">
							...
							<div class="card-body">
								<ul>
									<li class=""><a href="product_index_grid.php"> Grid View</a></li>
									<li class=""><a href="product_index.php">List View</a></li>
								</ul>
								<a href="product_create.php" class="btn btn-outline bg-grey border-grey text-grey-600 btn-icon rounded-round border-2 legitRipple" style="color: blue;"><i class="icon-plus2"></i></a> 
